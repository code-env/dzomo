    ...
    <div className="h-full w-full pt-40">
      <div className="max-w-xl  w-full mx-auto flex flex-col items-center gap-4">
        <div className="flex flex-col items-center gap-2">
          ...
          />
          <h1 className="font-bold text-5xl">Dzomo</h1>
        </div>
        <p className=" text-neutral-800 text-center text-lg">
          Convert your files effortlessly all from the terminal
        </p>
        <div className="flex items-center gap-4">
          <Button asChild className="min-w-40">
            <a
              href="https://www.npmjs.com/package/dzomo"
              target="_blank"
              rel="noreferrer"
            >
              Npm Package
          ...
          <Button asChild variant="outline" className="min-w-40">
            <a
              href="https://github.com/code-env/dzomo"
              target="_blank"
              rel="noreferrer"
            >
              Github
...
const Installation = () => {
  ...
  const onCopy = useCallback(() => {
    navigator.clipboard.writeText("npm install -g dzomo");
    setCopying((c) => c + 1);
    setTimeout(() => {
      setCopying((c) => c - 1);
    }, 2000);
